package ru.sms.addons.pdfviewer;
...
public class PdfviewerTestContainer extends TestContainer {

    public PdfviewerTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "ru/sms/addons/pdfviewer/app.properties",
    ...
    public static class Common extends PdfviewerTestContainer {

        public static final PdfviewerTestContainer.Common INSTANCE = new PdfviewerTestContainer.Common();
